...
### Modify
- `.envrc` — May need updating if flake changes environment structure
- `README.md` — Document Nix flake usage for new contributors

### Create
- `flake.nix` — Nix flake definition with Go toolchain, dev tools, and shell
- `flake.lock` — Auto-generated lock file for reproducible builds